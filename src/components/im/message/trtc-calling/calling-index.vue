...
<!--                <div>-->
<!--                    <img class="image" src="../../../../assets/images/camera-max.png"/>-->
...
@width5: 100%; // Appears 8 times
@width6: 70%; // Appears 2 times

// Height variables (appears count calculates by raw css)
@height4: 100%; // Appears 5 times
...
.accept {
	...
	background-size: 60%;
	background: center no-repeat url("../../../../assets/images/call.png");
}
.refuse {
	background-color: red;
	background-size: 70%;
	background: center no-repeat url("../../../../assets/images/close.png");
}
.videoOn {
	background: center no-repeat url("../../../../assets/images/big-camera-on.png");
}
.videoOff {
	background: center no-repeat url("../../../../assets/images/big-camera-off.png");
}
.micOn {
	background: center no-repeat url("../../../../assets/images/big-mic-on.png");
}
.micOff {
	background: center no-repeat url("../../../../assets/images/big-mic-off.png");
}
.buttons {
	display: flex;
