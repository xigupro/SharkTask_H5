  ...
  <div class="message-wrapper" :class="messagePosition">
    ...
    >
      <div class="col-1" v-if="showAvatar">
        <!-- 头像 -->
        <van-image round height="50px" width="50px" :src="avatar" />
      </div>
      <div class="col-2">
        <!-- 消息主体 -->
    ...
    >
      ...
      <div class="col-1" v-if="showAvatar" >
        <van-image round height="50px" width="50px" class="group-member-avatar" :src="avatar" @click.native="showGroupMemberProfile"/>
      </div>
      <div class="col-2">
        <!-- 消息主体 -->
    ...
    <div class="system-layout" v-if="currentConversationType === TIM.TYPES.CONV_SYSTEM ">
      <div class="col-1">
        <van-image round height="50px" width="50px" :src="avatar" :type="currentConversationType" />
      </div>
      <div class="col-2">
